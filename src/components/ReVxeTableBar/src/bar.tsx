      ...
      nextTick(() => {
        ...
        Sortable.create(wrapper, {
          ...
          onEnd: ({ newIndex, oldIndex, item }) => {
            ...
            const actualOldIndex = oldIndex + specialColumnCount;
            const actualNewIndex = newIndex + specialColumnCount;
            ...
            // 使用实际索引进行拖拽操作
            const currentRow = dynamicColumns.value.splice(actualOldIndex, 1)[0];
