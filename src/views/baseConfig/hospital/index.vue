...
import { ref } from "vue";
import { useHospital } from "./utils/hook";
  ...
  <div class="main">
    ...
    >
      ...
      <el-form-item label="院区编号：" prop="hospital_district_no">
        <el-input
          v-model="form.hospital_district_no"
          placeholder="请输入院区编号"
          clearable
          class="w-[180px]!"
        />
    ...
    >
      ...
      <template #operation="{ row, size }">
        ...
        <el-button
          ...
          type="primary"
          :size="size"
          :icon="useRenderIcon(CheckCircle)"
          @click="handleSwitchStatus(row)"
        >
          启用
        </el-button>
